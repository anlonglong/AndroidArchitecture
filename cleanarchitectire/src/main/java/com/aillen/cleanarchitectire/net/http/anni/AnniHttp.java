package com.aillen.cleanarchitectire.net.http.anni;

import com.aillen.cleanarchitectire.net.BaseHttpOutput;
import com.aillen.cleanarchitectire.net.contract.IHttpContracts;
import com.aillen.cleanarchitectire.net.http.DownloadListener;
import com.aillen.cleanarchitectire.net.http.ExecutorRequest;
import com.aillen.cleanarchitectire.net.http.HttpListener;
import com.aillen.cleanarchitectire.net.http.HttpMethod;
import com.aillen.cleanarchitectire.net.http.IExecutorRequest;
