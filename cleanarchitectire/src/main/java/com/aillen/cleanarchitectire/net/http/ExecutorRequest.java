package com.aillen.cleanarchitectire.net.http;
...
import com.aillen.cleanarchitectire.net.contract.IHttpContracts;
import com.aillen.cleanarchitectire.net.http.anni.AnniHttp;
import com.aillen.cleanarchitectire.net.http.anno.IRequest;
            ...
            switch (HttpListener.HttpState.get(msg.what)) {
                ...
                case UPDATA_SUCCESS:
                    if (null != mDownLoadListener) {
                        ...
                        BigDecimal bigDecimal = new BigDecimal(data.component2() * 1.0 / data.component1()).setScale(2, RoundingMode.UP);
                        mDownLoadListener.onResponse(result.getCall(), data.component1(), data.component2(), bigDecimal.doubleValue());
                    }
                    break;
                default:
